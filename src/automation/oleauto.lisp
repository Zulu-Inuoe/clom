...
(defconstant stdole_majorvernum #x01)
(defconstant stdole_minorvernum #x00)
(defconstant stdole_lcid #x0000)

;; Version # of stdole2.tlb
(defconstant stdole2_majorvernum #x2)
(defconstant stdole2_minorvernum #x00)
(defconstant stdole2_lcid #x0000)
...
(defwin32fun ("SysAllocString" sys-alloc-string :convention :stdcall :library oleaut32) bstr
  (psz (:pointer olechar)))
